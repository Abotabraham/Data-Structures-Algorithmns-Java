/**
 * Binary heap implementation: both max and min heap using an array
 *
...
// peek the value at the top the heap and return the value
  public Integer peek() {
    if (isEmpty()) {
...
// breath first search of the heap
